...
export function VisualisationHolder(config,attr){
	...
	this.wrap = function(inner){
		...
		html += (leg && legpos.top && !legpos.left && !legpos.right ? leg : '');
		html += '<div class="oi-left">' + (leg && legpos.top && legpos.left && !legpos.right ? leg : '') + '</div>';
		html += '<div class="oi-right">' + (leg && legpos.top && !legpos.left && legpos.right ? leg : '') + '</div>';
		html += '</div>';
		html += inner;
		html += '<div class="oi-bottom">';
		html += '<div class="oi-left">' + (leg && legpos.bottom && legpos.left && !legpos.right ? leg : '') + '</div>';
		html += '<div class="oi-right">' + (leg && legpos.bottom && !legpos.left && legpos.right ? leg : '') + '</div>';
		html += (leg && legpos.bottom && !legpos.left && !legpos.right ? leg : '');
		html += '</div>';
